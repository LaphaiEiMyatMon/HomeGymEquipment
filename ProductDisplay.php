...
include('connect.php');
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            <a href="" class="navbar-brand d-block d-lg-none">
                <h1 class="m-0 display-5 text-capitalize font-italic text-white"><span class="text-primary">Gallery page</span></h1>
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="ProductDisplay.php" class="nav-item nav-link active">Gallery</a>
                 ...
                 <a href="RSSFeed.php" class="btn-lg btn-primary" >RSS Feed</a>
 ...
 <fieldset>
	...
	else
	{
		for ($i=0; $i <$count ; $i+=4) 
		{ 
			$query1="SELECT * FROM Product ORDER BY ProductID LIMIT $i,4";
			...
			for ($a=0; $a <$count1 ; $a++)
			 { 
			 	...
			 	<td align="center"><br><br>
			 		<img src="<?php echo $image ?>" width="340px" height="320px"><br><br>
 ...
 <div class="container-fluid bg-dark text-white py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-12 mb-5">
                ...
                <a href="/HGE/ProductDisplay.php">You Are At Gallery Page. </a>
