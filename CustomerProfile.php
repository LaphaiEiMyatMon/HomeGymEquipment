        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="CustomerProfile.php" class="nav-item nav-link active">Profile</a>
                </div>
 ...
 <form action="CustomerProfile.php" method="POST">
  ...
  <div class="card bg-primary text-white" style="width:400px" >
      ...
      <table >
 		...
 		<br>
 		  <a href="CustomerProfileUpdate.php" class="  btn btn-success">Update</a>
 		 <a href="CustomerProfileDelete.php" class="  btn btn-danger ">Delete</a>
