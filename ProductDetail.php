...
if (isset($_GET['ProductID'])) 
{
	...
	$ProductAmount=$arr['ProductAmount'];
	$ProductQuantity=$arr['ProductQuantity'];
	$img=$arr['ProductImage'];
	$Des=$arr['Description'];
	$ProductType=$arr['ProductTypeID'];
	$status=$arr['Status'];
 	...
 	<form action="Shopping_Cart.php" method="GET" enctype="multipart/form-data">
 		...
 		<input type="hidden" name="txtProductID" value="<?php echo $ProductID ?>">
 		 <br><fieldset>
            ...
            <legend class="text-primary" align="center" font><b><u>Detail about <?php echo $ProductName  ?></u> </b></legend>
 			
 			<table align="center">
 				<tr>
 					<td style="width:55%">
 					<br>
 						<img src="<?php echo $img ?>" width="250px" height="250px"/><br>
 					</td>
 					...
 					<td>
 						<table>
 							...
 							<tr>
 								<td>Product Price :</td>
 								<td>
 									<b><?php echo $ProductAmount ?></b>MMK
                                    <br>
 								</td>
 							</tr>
 							...
 							<tr>
 								...
 								<td>
 								<b><?php echo $ProductQuantity ?></b>Pcs
 								</td>
 							</tr>

 							<tr>
 								<td>Buy Quantity  :</td><br>
 								<td>
 								<input type="number" name="txtBuyQty" min="1" max="<?php echo $ProductQuantity ?>">
 								</td>
 							</tr>
 							...
 							<tr>
 								...
 								<td>
                                    <br>
 									<input type="submit" class="btn btn-success"   name="Buy" min="1" value="Add to Cart">
 								</td>
 							</tr>
  ...
  <div class="container-fluid bg-dark text-white py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-12 mb-5">
                ...
                <a href="/HGE/ProductDetail.php">You Are At Product Detail Page. </a>
